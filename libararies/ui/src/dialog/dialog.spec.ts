...
// import { Dialog, DIALOG_DATA, DIALOG_DEFAULT_OPTIONS } from './dialog';
...
//
//     viewContainerFixture.detectChanges();
//     const dialogContainerElement = overlayContainerElement.querySelector('ui-dialog-container');
...
//     expect(overlayContainerElement.querySelector('ui-dialog-container')).toBeNull();
//   }));
//
...
//       expect(overlayContainerElement.querySelector('ui-dialog-container'))
...
//     flushMicrotasks();
//
//     expect(overlayContainerElement.querySelectorAll('ui-dialog-container').length)
...
//     flush();
//
//     expect(overlayContainerElement.querySelector('ui-dialog-container')).toBeFalsy();
//   }));
//
...
//
//     const backdrop = overlayContainerElement.querySelector('.cdk-overlay-backdrop') as HTMLElement;
//     const container = overlayContainerElement.querySelector('ui-dialog-container') as HTMLElement;
...
//     dialog.open(PizzaMsg);
//
//     expect(overlayContainerElement.querySelectorAll('ui-dialog-container').length).toBe(3);
//
//     dialog.closeAll();
//     viewContainerFixture.detectChanges();
//     flush();
//
//     expect(overlayContainerElement.querySelectorAll('ui-dialog-container').length).toBe(0);
//   }));
//
//   it('should set the proper animation states', () => {
//     const dialogRef = dialog.open(PizzaMsg, { viewContainerRef: testViewContainerRef });
//     const dialogContainer: DialogContainerComponent =
//       viewContainerFixture.debugElement
//         .query(By.directive(DialogContainerComponent))
//         .componentInstance;
//
...
//     dialog.open(PizzaMsg);
//
//     expect(overlayContainerElement.querySelectorAll('ui-dialog-container').length).toBe(2);
//
...
//     flush();
//
//     expect(overlayContainerElement.querySelectorAll('ui-dialog-container').length).toBe(1);
//   }));
//
...
//
//       const instance =
//         dialog.open(DialogWithInjectedData, config).componentInstance as any;
//
...
//         expect((dialogRef.componentInstance as any).data).toBeNull();
//       }).not.toThrow();
//     });
//   });
//
...
//       flush();
//
//       expect(overlayContainerElement.querySelector('ui-dialog-container')).toBeTruthy();
//     }));
//
...
//
//     it(
//       'should move focus to the container if there are no focusable elements in the dialog',
//       fakeAsync(() => {
...
//
//         expect(document.activeElement.tagName)
//           .toBe('ui-dialog-container', 'Expected dialog container to be focused.');
//       }),
//     );
//
...
//
//       it(
//         'should return the [mat-dialog-close] result when clicking the close button',
//         fakeAsync(() => {
//           const afterCloseCallback = jasmine.createSpy('afterClose callback');
//           dialogRef.afterClosed().subscribe(afterCloseCallback);
//
...
//         const container = overlayContainerElement.querySelector('ui-dialog-container');
//
//         flush();
//         viewContainerFixture.detectChanges();
//
...
// });
//
// describe('Dialog with a parent MatDialog', () => {
...
//
//   it(
//     'should close dialogs opened by a parent when calling closeAll on a child MatDialog',
//     fakeAsync(() => {
...
//
//   it(
//     'should close dialogs opened by a child when calling closeAll on a parent MatDialog',
//     fakeAsync(() => {
...
// });
//
// describe('Dialog with default options', () => {
//   let dialog: Dialog;
//   let overlayContainer: OverlayContainer;
//   let overlayContainerElement: HTMLElement;
//
...
//       imports: [DialogModule, DialogTestModule],
//       providers: [
//         { provide: DIALOG_DEFAULT_OPTIONS, useValue: defaultConfig },
//       ],
//     });
//
//     TestBed.compileComponents();
...
//
//   beforeEach(inject(
//     [Dialog, OverlayContainer],
//     (d: Dialog, oc: OverlayContainer) => {
//       dialog = d;
//       overlayContainer = oc;
//       overlayContainerElement = oc.getContainerElement();
//     },
